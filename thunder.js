let animationID, canvas, ctx, w, h, thunder, text, particles, input;
...
function Text(options) {
  ...
  buffer.lineWidth = 5; // Increased line width for thicker text
...
function loop() {
  update();
  render();
  animationID = requestAnimationFrame(loop); // Assign the returned ID to animationID
}
...
function redirectPage() {
  setTimeout(() => {
    window.location.href = 'main.html'; // Replace 'new_page.html' with the URL of the page you want to redirect to
  }, 100); // 15 seconds (15,000 milliseconds)
}